...
# G(z)
def generator(g,x, isTrain=True, reuse=False):
...
# D(x)
def discriminator(g,x, isTrain=True, reuse=False):
...
# tf.summary.scalar('D_lossoss',D_loss)
...
# summary_writer = tf.summary.FileWriter('./DeepGan', sess.graph)
